...
void main(List<String> args) async {
  if (args.isEmpty) {
    print(
      'Usage: dart run audit_conversation.dart <app_data_dir> [convo_id1 convo_id2 ...] [--last N]',
    );
    exit(1);
  }
        ...
        if (toolName == 'run_command') {
          ...
          if (argsData is String) {
            try {
              ...
              argsData = <String, dynamic>{};
            }
          }

          if (argsData is Map) {
            dynamic cmd =
                argsData['CommandLine'] ??
                argsData['command_line'] ??
                argsData['command'];
